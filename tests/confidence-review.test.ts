    ...
    amounts: [
      {
        ...
        lineIndex: 10,
        roleScores: { itemPrice: 0, subtotal: 0, tax: 0, discount: 0, total: 0.9, cash: 0, change: 0, unknown: 0 },
        confidence: 0.9,
      },
      {
        value: 28,
        ...
        box: { x: 0, y: 0, width: 1, height: 1 },
        lineIndex: 11,
        roleScores: { itemPrice: 0, subtotal: 0, tax: 0, discount: 0, total: 0.85, cash: 0, change: 0, unknown: 0 },
        confidence: 0.85,
      },
    ],
  });
    ...
    amounts: [
      {
        ...
        box: { x: 0, y: 0, width: 1, height: 1 },
        lineIndex: 8,
        roleScores: { itemPrice: 0, subtotal: 0, tax: 0.92, discount: 0, total: 0.2, cash: 0, change: 0, unknown: 0 },
        confidence: 0.8,
      },
    ],
  });
